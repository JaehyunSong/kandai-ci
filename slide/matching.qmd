...
```{r}
#| include: false
pacman::p_load(tidyverse, gt, gtExtras, broom, modelsummary, 
...
tibble(ID     = 1:2,
  ...
  gt_highlight_cols(columns = 6, fill = "lightblue")
```

* ITEの**加重**平均 $\rightarrow$ 講義履修の因果効果 $\rightarrow$ 約**191.6万円**
...
::::{.columns}
:::{.column width=30%}
![](figs/matching/Mahalanobis.png){fig-align="center"}
:::
...
* 詳細は『私たちのR』[第22章](https://www.jaysong.net/RBook/visualization4.html#visual4-dag)を参照
...
:::{.aside}
* Lalonde, Robert. 1984. "[Evaluating the Econometric Evaluations of Training Programs with Experimental Data](https://www.jstor.org/stable/1806062)," *American Economic Review,* 76 (4): 604-620.
:::
