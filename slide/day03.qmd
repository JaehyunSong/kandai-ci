...
Song, Jaehyun, Takeshi Iida, Yuriko Takahashi, and Jesús Tovar. 2022 (forthcoming). "[Buying Votes across Borders? A List Experiment on Mexican Immigrants in the US](https://www.waseda.jp/fpse/winpec/public/working-paper/)," *Canadian Journal of Political Science*.
...
* 例) AさんITEは
   * 例1) Bさんが統制群の場合は10、処置群の場合は5 $\leftarrow$ `r fontawesome("angry")`
   * 例2) Bさんが統制群の場合も、処置群の場合も、5 $\leftarrow$ `r fontawesome("smile")`
