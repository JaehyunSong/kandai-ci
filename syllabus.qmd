...
|  5 | 2022/10/24 | Rの復習（2） |
|  6 | 2022/10/24 | Rの復習（3） |
|  7 | 2022/11/07 | 回帰分析とマッチング（理論） |
|  8 | 2022/11/14 | 回帰分析とマッチング（理論） |
|  9 | 2022/11/21 | 回帰分析とマッチング（実習） |
| 10 | 2022/11/28 | 回帰分析とマッチング（実習） |
| 11 | 2022/12/05 | 差分の差分法（理論） |
| 12 | 2022/12/12 | 差分の差分法（実習） |
| 13 | 2022/12/19 | 回帰不連続デザイン（理論） |
| 14 | 2022/12/26 | 回帰不連続デザイン（実習） |
